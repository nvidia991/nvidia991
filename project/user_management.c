#include <stdio.h> 
#include <string.h>  // library has many functions that allow you to perform tasks on strings.
#include <unistd.h>  // 
#include <termios.h>  //

#define MAX_USERS 10   // define, max_user ma value 10 haleko. 
#define CREDENTIAL_LENGTH 30   // CREDENTIA 
...
int main() {
  int option;
  int user_index;
  while (1) {                               // loop ma manu continue chalaune.
    printf ("\nWelcome to User Management");  // Input manu.
    printf ("\n1. Register");
    printf ("\n2. Login");
    printf ("\n3. Exit");
    printf ("\nSelect an option: ");
